...
int main(int argc, char *argv[]){
    ...
    int nvalues[] = {100, 500, 1000, 2000,5000, 10000};
    int threadvalues[] = {1,2,3,4,6,8};
    // Read arguments
    #ifdef ANALYSIS
        FILE * analysis_file = fopen("analysis2.csv", "w");
    #endif 

for (int iteration = 0; iteration < 10; iteration++){
for(int nv = 0; nv < 6; nv++){
for(int threadv = 0; threadv < 6; threadv++){

    int num_threads = threadvalues[threadv];
